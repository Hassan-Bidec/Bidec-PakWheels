...
// import { FaShieldAlt, FaMobileAlt, FaThLarge, FaChartLine, FaCheckCircle } from "react-icons/fa";
...
//           {t("Ma3rood is Saudi Arabia’s modern, mobile-first marketplace designed to connect buyers and sellers with ease, trust, and efficiency. Whether you’re searching for a family car, a new home, a job opportunity, or unique household items, Ma3rood brings it all together in one simple, secure platform.")}
//           </p>
//           <p className="mt-4 leading-relaxed">
//             {t("We go beyond just listings — we empower individuals, businesses,and communities to trade smarter, faster, and with confidence.")}
//           </p>
//         </div>
...
//           To create Saudi Arabia’s most trusted and user-friendly online
//           marketplace — making buying and selling effortless for everyone,
//           from first-time users to seasoned traders.
//         </p>
//       </section>
...
//             <h3 className="font-semibold text-lg mb-2">Comprehensive Categories</h3>
//             <p className="text-sm">From cars and homes to jobs, services, and more.</p>
//           </div>
//           <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg text-center">
//             <FaShieldAlt className="text-blue-600 text-4xl mx-auto mb-4" />
//             <h3 className="font-semibold text-lg mb-2">Trusted Connections</h3>
//             <p className="text-sm">Secure messaging & verification for safe trading.</p>
//           </div>
//           <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg text-center">
//             <FaChartLine className="text-blue-600 text-4xl mx-auto mb-4" />
//             <h3 className="font-semibold text-lg mb-2">Powerful Seller Tools</h3>
//             <p className="text-sm">Manage listings, chat with buyers & track deals.</p>
//           </div>
//           <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg text-center">
...
//             <p className="text-sm">Clean, responsive, and built for today’s users.</p>
//           </div>
//         </div>
//       </section>
...
//           <h2 className="text-3xl font-bold text-center mb-12">Why Ma3rood?</h2>
...
//                 100% focused on the Saudi market. Every feature is tailored to the unique
//                 buying and selling habits of people in the Kingdom.
//               </p>
//             </div>

//             <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg">
//               <FaLock className="text-green-600 text-3xl mb-3" />
//               <h3 className="font-semibold text-xl mb-2">Secure Trading</h3>
//               <p className="text-gray-600">
//                 Advanced security, safe messaging, and verification systems protect
//                 every transaction so you can trade with confidence.
//               </p>
//             </div>
...
//               <p className="text-gray-600">
//                 Empowering individuals, families, and SMEs across Saudi Arabia to
//                 connect, grow, and thrive together through trade.
//               </p>
//             </div>

//             <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg">
//               <FaRobot className="text-green-600 text-3xl mb-3" />
//               <h3 className="font-semibold text-xl mb-2">AI-Enhanced Experience</h3>
//               <p className="text-gray-600">
//                 Smart search, intelligent recommendations, and fraud detection tools
...
//           <p className="text-lg">
//             To become the Kingdom’s most trusted and widely used online
//             marketplace, where millions of Saudis and residents connect daily.
//           </p>
//         </div>
//       </section>
...
//           “At Ma3rood, we’re not just building a platform — we’re building a
//           trusted trade community for the Kingdom.”
//         </blockquote>
//       </section>
//     </div>
//   );
