...
const ChangeUsername = () => {
  ...
  <h2 className="text-2xl font-semibold mb-2 text-black">{t("Change Fullname")}</h2>
    ...
    {t("You will only be able to change it once every 30 days.")}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="new_name" className="block text-sm font-semibold mb-1">
            ...
            />
            {errors.new_name && (
              <p className="text-red-500 text-sm mt-1">{errors.new_name.message}</p>
            )}
          </div>
